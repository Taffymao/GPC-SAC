...
from experiment_configs.configs.q_learning.gpc_sac_config import get_config
...
def main(args):
    ...
    variant['trainer_kwargs']['action_n'] = args.action_n
    variant['trainer_kwargs']['state_n'] = args.state_n
...
if __name__ == '__main__':
    ...
    parser.add_argument('--beta',
                        default=4,
                        type=float,
                        help='control the size of u.')
    parser.add_argument('--state_n',
                        default=7,
                        type=float,
                        help='The number of partitions in the state space.')
    parser.add_argument('--action_n',
                        default=7,
                        type=float,
                        help='The number of partitions in the state space.')
