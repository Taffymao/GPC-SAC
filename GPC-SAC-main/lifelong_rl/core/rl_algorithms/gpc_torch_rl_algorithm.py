...
from lifelong_rl.core.rl_algorithms.offline.gpc_rl_algorithm import OfflineRLAlgorithm
...
class TorchTrainer(Trainer, metaclass=abc.ABCMeta):
    ...
    def train(self, np_batch,indices,epoch):
        self._num_train_steps += 1
        batch = np_to_pytorch_batch(np_batch)
        self.train_from_torch(batch,indices,epoch)
