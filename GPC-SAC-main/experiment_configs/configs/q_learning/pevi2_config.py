...
from lifelong_rl.trainers.q_learning.pevi2 import PEVITrainer
...
def get_config(
    ...
    qfs, target_qfs = [], []
    for _ in range(variant['trainer_kwargs']['num_qs']):
    ...
    config.update(
        dict(
            ...
            exploration_policy2=policy2,
            evaluation_policy=MakeDeterministic(policy),
            evaluation_policy2=MakeDeterministic(policy2),
